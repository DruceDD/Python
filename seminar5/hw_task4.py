...
#РЕШЕНО СОВМЕСТНО С ЗЕВИНОЙ ЕЛЕНОЙ
import re
...
with open('hw_task_4.txt', 'w') as file:
    file.write(st)


# 2 часть задачи:
with open('hw_task_4.txt') as file:
    part_2 = file.read()
...
with open('hw_task_4_2.txt', 'w') as file:
    file.write(res)

if s == res:
    print('Проверка соответствия исходной строки и результата дешифровки:', True)
else:
    print('Проверка соответствия исходной строки и результата дешифровки:', False)