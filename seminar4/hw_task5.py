...
with open('hw_task4.txt') as f1:  # получаем 1й многочлен из одного файла
    first_mn = f1.read()

with open('hw_task5.txt') as f2:  # получаем 2й многочлен из другого файла
    second_mn = f2.read()
...
with open('hw_task5_result.txt', 'w') as file:
    file.write(result)